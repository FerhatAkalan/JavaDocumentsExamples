...
public class HesapTesti {
	...
	public static void main(String[] args) {
		...
		System.out.print("Hesap1 için yatırılacak miktarı giriniz: ");
		...
		System.out.print("Hesap2 için yatırılacak miktarı giriniz: ");
		yatirilanMiktar = input.nextDouble();
		System.out.printf("Hesap2\'e %.2f TL yatırılıyor\n", yatirilanMiktar);
